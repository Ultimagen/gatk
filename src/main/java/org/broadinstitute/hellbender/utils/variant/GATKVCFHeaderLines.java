...
public class GATKVCFHeaderLines {
    ...
    static {
        ...
        addInfoLine(new VCFInfoHeaderLine(FLOW_AS_TP_TABLE, 1, VCFHeaderLineType.String, "Flow: additional strand based error information derived from tp attribute"));
